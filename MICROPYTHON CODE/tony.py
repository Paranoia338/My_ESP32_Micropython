...
#         print(value)
        if value == 0:
            return -1
        return ((((1023.0/float(value)) * 5.0) - 1.0) * self.RLOAD)
    ...
    def get_ppm(self):
        ...
        #rint("\nResistance {}".format(self.get_resistance()))
    ...
    def get_corrected_ppm(self, temperature, humidity):
        ...
        #print("Corrected Resistance {}".format(self.get_corrected_resistance(temperature, humidity)))
